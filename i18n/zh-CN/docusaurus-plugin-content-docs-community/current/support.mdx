...
Hey there! git checkout -b supportWelcome to Apache Answer, a Q&A platform software. We've got a bunch of curious and helpful users who are always willing to give a hand.
...
<a href="https://meta.answer.dev" className="btn btn-lg btn-primary"><i className="bi bi-chat-square-text-fill me-2"></i>Discussion forum</a>
